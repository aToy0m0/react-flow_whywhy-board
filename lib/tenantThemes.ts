...
const brightTheme: TenantTheme = {
  key: 'bright',
  label: 'Bright Day',
  description: '明るく快適なライトテーマ、視認性を重視したクリーンなデザイン',
  previewGradient: 'linear-gradient(135deg, #fffffe 0%, #ffd803 100%)',
  cssVars: {
    ...
    '--color-button-hover': '#ffcc02',
    '--color-danger-text': '#d63447',
    '--surface-card-muted': 'rgba(45, 51, 74, 0.03)',
    '--surface-card': 'rgba(45, 51, 74, 0.05)',
    '--surface-card-strong': 'rgba(45, 51, 74, 0.08)',
    '--surface-muted': 'rgba(39, 35, 67, 0.08)',
    '--surface-panel': 'rgba(39, 35, 67, 0.06)',
    '--surface-code': 'rgba(39, 35, 67, 0.04)',
    '--surface-overlay': 'rgba(255, 255, 254, 0.95)',
    '--surface-overlay-strong': 'rgba(255, 255, 254, 0.98)',
    '--surface-hover': 'rgba(255, 216, 3, 0.08)',
    '--surface-hover-strong': 'rgba(255, 216, 3, 0.12)',
    '--surface-active': 'rgba(255, 216, 3, 0.18)',
    '--surface-danger': 'rgba(214, 52, 71, 0.08)',
    '--border-subtle': 'rgba(45, 51, 74, 0.12)',
    '--border-soft': 'rgba(45, 51, 74, 0.18)',
    '--border-overlay': 'rgba(45, 51, 74, 0.25)',
    '--border-accent': 'rgba(255, 216, 3, 0.6)',
    '--border-soft-accent': 'rgba(255, 216, 3, 0.4)',
    '--border-accent-strong': 'rgba(255, 216, 3, 0.8)',
    '--border-strong': 'rgba(39, 35, 67, 0.35)',
    '--border-danger': 'rgba(214, 52, 71, 0.4)',
    '--accent-solid': '#ffd803',
    '--accent-solid-hover': '#ffcc02',
    '--accent-soft': '#fff3a0',
    '--accent-soft-hover': '#fff8c4',
    '--accent-border': '#ffd803',
    '--accent-border-active': '#ffcc02',
    '--accent-ring': 'rgba(255, 216, 3, 0.3)',
    '--accent-ring-soft': 'rgba(255, 243, 160, 0.5)',
    '--ring-primary': 'rgba(45, 51, 74, 0.15)',
    '--ring-highlight': 'rgba(255, 216, 3, 0.25)',
    '--grid-dot-color': 'rgba(45, 51, 74, 0.15)',
  },
};

const earthTheme: TenantTheme = {
  key: 'earth',
  label: 'Warm Earth',
  description: 'ウォームなアースカラーで温かみのあるナチュラルテーマ',
  previewGradient: 'linear-gradient(135deg, #f9f4ef 0%, #8c7851 100%)',
  cssVars: {
    ...
    '--color-button-hover': '#7a6a47',
    '--color-danger-text': '#f25042',
    '--surface-card-muted': 'rgba(113, 96, 64, 0.04)',
    '--surface-card': 'rgba(113, 96, 64, 0.06)',
    '--surface-card-strong': 'rgba(113, 96, 64, 0.10)',
    '--surface-muted': 'rgba(2, 8, 38, 0.06)',
    '--surface-panel': 'rgba(234, 221, 207, 0.5)',
    '--surface-code': 'rgba(234, 221, 207, 0.3)',
    '--surface-overlay': 'rgba(249, 244, 239, 0.95)',
    '--surface-overlay-strong': 'rgba(249, 244, 239, 0.98)',
    '--surface-hover': 'rgba(140, 120, 81, 0.08)',
    '--surface-hover-strong': 'rgba(140, 120, 81, 0.12)',
    '--surface-active': 'rgba(140, 120, 81, 0.18)',
    '--surface-danger': 'rgba(242, 80, 66, 0.08)',
    '--border-subtle': 'rgba(113, 96, 64, 0.15)',
    '--border-soft': 'rgba(113, 96, 64, 0.20)',
    '--border-overlay': 'rgba(113, 96, 64, 0.30)',
    '--border-accent': 'rgba(140, 120, 81, 0.6)',
    '--border-soft-accent': 'rgba(140, 120, 81, 0.4)',
    '--border-accent-strong': 'rgba(140, 120, 81, 0.8)',
    '--border-strong': 'rgba(2, 8, 38, 0.25)',
    '--border-danger': 'rgba(242, 80, 66, 0.4)',
    '--accent-solid': '#8c7851',
    '--accent-solid-hover': '#7a6a47',
    '--accent-soft': '#c4b699',
    '--accent-soft-hover': '#d9ceb3',
    '--accent-border': '#8c7851',
    '--accent-border-active': '#7a6a47',
    '--accent-ring': 'rgba(140, 120, 81, 0.3)',
    '--accent-ring-soft': 'rgba(196, 182, 153, 0.5)',
    '--ring-primary': 'rgba(113, 96, 64, 0.15)',
    '--ring-highlight': 'rgba(140, 120, 81, 0.25)',
    '--grid-dot-color': 'rgba(113, 96, 64, 0.15)',
  },
};
...
const modernTheme: TenantTheme = {
  ...
  cssVars: {
    ...
    '--color-muted': '#5a5a5a',
    '--color-subtle': '#7a7a7a',
    '--color-highlight': '#ff8e3c',
    '--color-secondary': '#fffffe',
    '--color-tertiary': '#d9376e',
    '--color-main': '#eff0f3',
    '--color-button': '#ff8e3c',
    '--color-button-text': '#0d0d0d',
    '--color-button-hover': '#e8803a',
    '--color-danger-text': '#d9376e',
    '--surface-card-muted': 'rgba(42, 42, 42, 0.03)',
    '--surface-card': 'rgba(42, 42, 42, 0.05)',
    '--surface-card-strong': 'rgba(42, 42, 42, 0.08)',
    '--surface-muted': 'rgba(13, 13, 13, 0.06)',
    '--surface-panel': 'rgba(255, 255, 254, 0.8)',
    '--surface-code': 'rgba(255, 255, 254, 0.6)',
    '--surface-overlay': 'rgba(239, 240, 243, 0.95)',
    '--surface-overlay-strong': 'rgba(239, 240, 243, 0.98)',
    '--surface-hover': 'rgba(255, 142, 60, 0.08)',
    '--surface-hover-strong': 'rgba(255, 142, 60, 0.12)',
    '--surface-active': 'rgba(255, 142, 60, 0.18)',
    '--surface-danger': 'rgba(217, 55, 110, 0.08)',
    '--border-subtle': 'rgba(42, 42, 42, 0.12)',
    '--border-soft': 'rgba(42, 42, 42, 0.18)',
    '--border-overlay': 'rgba(42, 42, 42, 0.25)',
    '--border-accent': 'rgba(255, 142, 60, 0.6)',
    '--border-soft-accent': 'rgba(255, 142, 60, 0.4)',
    '--border-accent-strong': 'rgba(255, 142, 60, 0.8)',
    '--border-strong': 'rgba(13, 13, 13, 0.25)',
    '--border-danger': 'rgba(217, 55, 110, 0.4)',
    '--accent-solid': '#ff8e3c',
    '--accent-solid-hover': '#e8803a',
    '--accent-soft': '#ffb580',
    '--accent-soft-hover': '#ffc999',
    '--accent-border': '#ff8e3c',
    '--accent-border-active': '#e8803a',
    '--accent-ring': 'rgba(255, 142, 60, 0.3)',
    '--accent-ring-soft': 'rgba(255, 181, 128, 0.5)',
    '--ring-primary': 'rgba(42, 42, 42, 0.15)',
    '--ring-highlight': 'rgba(255, 142, 60, 0.25)',
    '--grid-dot-color': 'rgba(42, 42, 42, 0.15)',
  },
};
