    ...
    <main className="min-h-screen bg-background text-paragraph">
      <div className="mx-auto w-full max-w-4xl px-6 pb-16 pt-24">
        <header className="mb-10 text-center">
          <p className="text-sm uppercase tracking-[0.4em] text-subtle">Documentation</p>
        ...
        <section className="space-y-4">
          {!repoBase && (
            <p className="rounded-2xl border border-accent/40 bg-accent/10 p-4 text-sm text-headline">
          ...
          {docEntries.map((doc) => (
            <article
              key={doc.path}
              className="rounded-2xl border border-soft bg-surface-card p-6 shadow-lg backdrop-blur transition hover:border-accent"
            >
              ...
              <div className="mt-4 text-sm text-accent">
                ...
                <code className="rounded bg-surface-card-muted px-2 py-1 text-headline">{doc.path}</code>
              </div>
              <div className="mt-4 flex gap-3 text-sm">
                <a
                  ...
                  className="rounded-lg bg-accent px-4 py-2 text-background transition hover:bg-accent/90"
                >
                  GitHub で開く
                </a>
              </div>
